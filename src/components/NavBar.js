...
export default function NavBar() {
  ...
  useEffect(() => {
    ...
    // Clear the timer
    return () => clearTimeout(timer); // clearTimeout(timeoutID): method clears a timer set with the setTimeout() method
  }, [userObj]);
      ...
      <Container>
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          <Nav className="me-auto">
            ...
            {/*  current tokens */}
            <FontAwesomeIcon icon={faCoins} className={animationClass} style={{ color: '#be8e00', fontSize: '1.3rem', marginLeft: '10px' }} />
